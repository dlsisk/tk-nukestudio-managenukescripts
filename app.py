...
class MultiWorkFiles(sgtk.platform.Application):
    ...
    def init_app(self):
        ...
        # Commenting out code for unneeded apps.
        """
        if self.engine.name == "tk-mari":
            ...
            return
        """
        self.engine.register_command("Open Comp...", self.show_file_open_dlg, {"short_name":"file_open"})
        self.engine.register_command("Save Comp...", self.show_file_save_dlg, {"short_name":"file_save"})
        
        # We shouldn't auto-start this app ever.
        """
    ...
    def destroy_app(self):
        ...
        Clean up app
        """
        self.log_debug("Destroying tk-nukestudio-managenukescripts")
